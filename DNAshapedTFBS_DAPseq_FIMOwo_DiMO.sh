...
'	path_scripts=../scripts
	...
	if [ -z "$(ls -A $fimo_dir/predictions/)" ]; then  
		...
		bash $path_scripts/predict_fimo.sh $meme_motif $fg_train_bed $fg_train_fasta $fg_train_FIMO_out
		python $path_scripts/reshape_fimo.py $fg_train_FIMO_out $fg_train_FIMO_pred
		
		bash $path_scripts/predict_fimo.sh $meme_motif $bg_train_bed $bg_train_fasta $bg_train_FIMO_out
		python $path_scripts/reshape_fimo.py $bg_train_FIMO_out	$bg_train_FIMO_pred
		
		bash $path_scripts/predict_fimo.sh $meme_motif $fg_test_bed $fg_test_fasta $fg_test_FIMO_out
		python $path_scripts/reshape_fimo.py $fg_test_FIMO_out $fg_test_FIMO_pred
		
		bash $path_scripts/predict_fimo.sh $meme_motif $bg_test_bed $bg_test_fasta $bg_test_FIMO_out
...
' $folder $meme_motif $from_methyl $methylation_FIMO $nsites $motif_bg $meme_alphabet -- {} 
